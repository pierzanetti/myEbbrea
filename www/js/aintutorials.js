...
.service('Aintutorials', [function(){
    ...
    var aintutorials_list = [
      ...
      { key: '	‛azab	', termine: '	עָזַב	', senza: '	עזב	', traslitterazione: '	‛āzaḇ	', significato: '	lasciare, abbandonare, perdere	', grammatica: '	v.	', altro: '	Qal, qatal, 3 ms, lascerà. (È il verbo utilizzato per indicare la deportazione in esilio)	', id: '	5	'},
